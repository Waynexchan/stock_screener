...
Invoke-Stage "Research mypy" { python -m mypy research/engine research/run_baseline.py research/run_filter_audit.py research/run_forward_test.py research/run_exit_stop_grid.py research/download_yahoo.py --ignore-missing-imports --disable-error-code import-untyped }
