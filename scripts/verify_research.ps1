...
Invoke-Stage "Research mypy" { python -m mypy research/engine research/run_baseline.py research/run_filter_audit.py research/run_forward_test.py research/run_exit_stop_grid.py research/run_portfolio_exposure.py research/run_combined_exit_exposure_grid.py research/run_easy_execution_cross_validation.py research/download_yahoo.py --ignore-missing-imports --disable-error-code import-untyped }
